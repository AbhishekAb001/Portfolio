...
class ProjectOnboard extends StatefulWidget {
...
class _ProjectOnboardState extends State<ProjectOnboard>
                          ...
                          child: Row(
                            children: [
                              Icon(
                                ...
                                size: width * 0.01, // Adjusted dot size
                              ),
                              SizedBox(width: width * 0.01),
                              Expanded(
                                child: Text(
                                  ...
                                  style: GoogleFonts.robotoSlab(
                                    color: Colors.white60,
                                    fontSize:
                                        width * 0.012, // Adjusted font size
